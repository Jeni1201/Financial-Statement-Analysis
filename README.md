...
- Analyse Profitability and operational efficiency trends.
- Evaluate financial leverage and risk.
...
| Page                            | Purpose                                                                                         |
| ------------------------------- | ----------------------------------------------------------------------------------------------- |
| Executive Summary               | High-level comparison of revenue, profit, assets, and company rankings.                         |
| Financial Performance Analysis  | Profitability, efficiency, and trend analysis using ROE, ROA, and margins.                      |
| Financial Health & Cash Quality | Evaluation of leverage risk and earnings quality using Debt-to-Equity and CFO-to-Profit ratios. |
